...
First, choose a location for your lab work and then create the necessary folders for all five Psych 1A labs.
...
knitr::include_graphics("images/setwd.gif")
...
* When citing a paper with multiple authors, if there are fewer than six authors the first time you cite the paper in the essay you should `r mcq(c(answer = "Write out all of the names", "Use et al."))`
...
* Download the <a href="fileslab2.zip" download>`lab 2 files`</a>, extract the files and then move them in to your Lab 2 folder.
