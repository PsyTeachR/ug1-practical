...
```{r fig.cap="Lower and upper tails"}
...
* Using `prnorm()` again, what is the proportion of Scottish men Fiona would be willing to date to 2 decimal places? `r fitb(c("0.23", ".23"))`  
