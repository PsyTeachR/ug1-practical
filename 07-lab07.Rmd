...
ggplot(dat, aes(name, prob)) +
  geom_col() +
  scale_y_continuous(limits = c(0,.3), name = "Probability of occurance") +
...
* What is this probabilty expressed in percent? `r mcq(c("0.25%", "2.5%", answer = "25%"))`
...
* What is this probabilty expressed in percent? `r mcq(c("0.06%", "0.6%", answer = "6%"))`
...
* What is this probabilty expressed in percent? `r mcq(c("0.017%", "0.17", answer = "17%"))`
...
* What is this probabilty expressed in percent? `r mcq(c("0.04%", "0.4%", answer = "4%"))`

### Activity 6: `pnorm` 2

Fiona is a very tall Scottish woman (181.12\nbsp{}cm) in the 16-24 y.o. range who will only date men who are taller than her.  

* What is the proportion of Scottish men would Fiona be willing to date to 2 decimal places? `r fitb(c("0.23", ".23"))`  
* What is this probabilty expressed in percent? `r mcq(c("0.23%", "2.3%", answer = "23%"))`
...
* What is this probabilty expressed in percent? `r mcq(c("0.99%", "9.9%", answer = "99%"))`
...
knitr::include_url("http://shiny.psy.gla.ac.uk/ShinyPsyTeachR/ug1/normal-distributions/",height = "800px")
