...
* Download the <a href="files/Psych1Bfiles.zip" download>`Psych 1B`</a> zip file, extract the files, and then move the three csv files to the folder you created above.  
