...
<p class="caption">(\#fig:unnamed-chunk-4)Basic barplot</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-5)Barplot with colour</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-6)Barplot without legend</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-7)Barplot with axis labels</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-8)Barplot with minimal theme</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-9)Barplot with colour-blind friendly colour scheme</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-10)Barplot with adjusted alpha</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-12)Violin-boxplot</p>
</div>
