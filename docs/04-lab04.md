...
* Download the <a href="files/lab4.zip" download>`lab 4 files`</a>, extract the files and then move them in to your Lab 3 folder.
...
The key thing to note in the above examples is the use of layers. Whilst we've built this up step-by-step, they are independent and you could remove any of them except for the first layer. Try running the above code but removing each layer and seeing how it affects the output.
