...
<input class='solveme nospaces' size='9' data-answer='["Happiness","TRUE"]'/> 

* What does the CES-D measure? 

<input class='solveme nospaces' size='10' data-answer='["Depression","TRUE"]'/>
...
<p class="caption">(\#fig:unnamed-chunk-9)Setting your working directory</p>
</div>
