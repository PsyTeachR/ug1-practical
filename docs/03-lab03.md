...
* Download the <a href="fileslab3.zip" download>`lab 3 files`</a>, extract the files and then move them in to your Lab 3 folder.
...
* Open the `stub-3.2.Rmd` file that you downloadd in the pre-class activities and ensure that the working directory is set to your Lab 3 folder and that the two .csv data files are in your working directory (you should see them in the file pane).   
...
* Change the above code to give you the **mean score**. What is the mean score to 2 decimal places? <input class='solveme nospaces' size='5' data-answer='["72.78"]'/>
...
* How would you change the code to group by education rathee than sex?
